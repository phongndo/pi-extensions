...
A local package for [Pi](https://github.com/earendil-works/pi): interactive clarification, Codex Fast Mode, multi-account routing, usage dashboards, summary-free context rollover, bounded web access, MCP tools, thirteen skills, and the `origin` theme.
